...
% Last Modified by GUIDE v2.5 01-Apr-2019 16:06:23
...
w = str2num(get(handles.edit1,'string'))
 rc = str2num(get(handles.edit2,'string'))
 tc = str2num(get(handles.edit3,'string'))
 S  = str2num(get(handles.edit10,'string'))
if w>=0
        t = (tc/rc);
            set(handles.edit4,'string',t)
        MAC = ((rc * 2/3) *(( 1 + t + (t*t) )/( 1 + t )));
            set(handles.edit5,'string',MAC)
        ac = (rc+tc)*(1/2)  
        wa = w*ac  
            set(handles.edit7,'string',wa)
         ar = (2 * w)/rc;
%              
         sw 	= ((S*(rc+2*tc))/(3*(rc+tc)))
             set(handles.edit8,'string',sw)
             
         sa = atand(ar/4) 
            set(handles.edit11,'string',sa)
         cg =(1/4 * MAC)+sw; 
            set(handles.edit6,'string',cg)
end        
